- <a name="loopmediagrouprobo-config-plugin-task-idx-ref-assortedservicejson">:open_file_folder:</a> <a href="#loopmediagrouprobo-config-plugin-task-ref-assortedservicejson">`assorted/@service.json`</a>
